...
def _get_page_edit_handler(cls):
    ...
    if hasattr(cls, "edit_handler"):
        ...
        # added list from SEO tags
        if cls.content_panels:
            tabs.append(
                ObjectList(
                    cls.content_panels + cls.promote_panels,
                    heading=gettext_lazy("Page Editor"),
                )
            )
        if cls.promote_panels:
            tabs.append(ObjectList(cls.promote_panels, heading=gettext_lazy("SEO Settings")))
