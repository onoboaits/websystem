...
def page_listing_more_buttons(page, page_perms, next_url=None):
    ...
    if page_perms.can_delete() and not page.is_site_root():
...
def register_reports_menu():
    return SubmenuMenuItem(
        _("Page Administration"),
        reports_menu,
        name="reports",
        icon_name="site",
        order=9000,
        classnames="fill-reports",
    )
...
#  return MenuItem('Frank', reverse('.'), icon_name='folder-inverse', order=10000)
