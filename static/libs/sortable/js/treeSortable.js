...
<!--                        </button>-->
                        <a href="./editor/cms/${id}"> <i class="fa-solid fa-eye"></i></a>
                        <button type="button" data-${idAttr}="${id}" class="button remove-branch" data-tippy-content="Remove Branch">
                            <i data-${idAttr}="${id}" class="fa-solid fa-trash"></i>
                        </button>
                    </div>
                </div>
            </div>
        ...
        $(treeSelector).sortable({
            ...
            stop(_, ui) {
                ...
                ui.item
                    ...
                    .attr(`data-${dataAttributes.parent}`, $parent.data(dataAttributes.id) === undefined ? 0 : $parent.data(dataAttributes.id));
            },
        });
    };
}
