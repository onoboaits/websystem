...
Vvveb.Builder = {
    ...
    _frameLoaded: function () {
        ...
        self.frameHead.append('<link data-vvveb-helpers href="' + Vvveb.baseUrl + '../../css/soft-ui-dashboard.css" rel="stylesheet">');
        ...
        Vvveb.old_content = Vvveb.Builder.getHtml();
    },
    ...
    saveAjax: function (fileName, startTemplateUrl, callback, saveUrl) {
        ...
        if (!startTemplateUrl || startTemplateUrl == null) {
            sssrc = ''
            html2canvas(this.getHtml().body).then(function (canvas) {
                var screenshotImage = new Image();
                screenshotImage.src = canvas.toDataURL();
                sssrc = screenshotImage.src;
            });
            console.log(sssrc)
            data["html"] = this.getHtml();
            data["old_html"] = Vvveb.old_content;
            data["screen_shot"] = sssrc;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // window.parent.location.href = "/editor-list";
                // console.log(data);
                var messageData = {
                    msg: data,
                    flag: "open"
...
Vvveb.Gui = {
    ...
    saveAjax: function () {
        ...
        var name = this.dataset.vvvebName;
        // var url = Vvveb.FileManager.getPageData('file');
        return Vvveb.Builder.saveAjax(name, null, function (data) {
