...
classicPickrDemo && Array.from(classicPickrDemo).forEach(function () {
    Pickr.create({
...
monolithColorPickr && Array.from(monolithColorPickr).forEach(function () {
    Pickr.create({
...
nanoColorPickr && Array.from(nanoColorPickr).forEach(function () {
    Pickr.create({
        el: ".nano-colorpicker",
        theme: "nano",
        default: "#3577f1",
...
demoColorPickr && Array.from(demoColorPickr).forEach(function () {
    Pickr.create({
        el: ".colorpicker-demo",
        theme: "monolith",
        default: "#405189",
...
opacityHueColorPickr && Array.from(opacityHueColorPickr).forEach(function () {
    Pickr.create({
...
swatcherColorPickr && Array.from(swatcherColorPickr).forEach(function () {
    Pickr.create({
...
inputColorPickr && Array.from(inputColorPickr).forEach(function () {
    Pickr.create({
